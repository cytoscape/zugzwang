...
public abstract class AbstractZZCustomGraphics<T extends CustomGraphicLayer> implements CyCustomGraphics<T>, Taggable 
{
	 ...
	 * @param displayName
	 */
	public AbstractZZCustomGraphics(final Long id, final String displayName) {
		this.id = id;
