package org.cytoscape.zugzwang.internal.charts.util;

import java.awt.Color;
import java.awt.Paint;

import org.cytoscape.zugzwang.internal.tools.MathUtil;
...
public class ColorScale implements PaintScale {
	...
	public static Paint getPaint(final double value,
		...
		final double f = value < 0.0 ? MathUtil.invLinearInterp(value, lowerBound, 0) : MathUtil.invLinearInterp(value, 0, upperBound);
