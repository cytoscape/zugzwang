...
{
	NORTH_WEST("Northwest", "NW", Conversion.NW), 
	NORTH("North", "N", Conversion.N), 
	NORTH_EAST("Northeast","NE", Conversion.NE), 
	WEST("West", "W", Conversion.W), 
	CENTER("Center", "C", Conversion.C), 
	EAST("East", "E", Conversion.E), 
	NONE("None", "NONE", Conversion.NONE), 
	SOUTH_WEST("Southwest", "SW", Conversion.SW), 
	SOUTH("South", "S", Conversion.S), 
	SOUTH_EAST("Southeast", "SE", Conversion.SE);
